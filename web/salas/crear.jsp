...
<html lang="en">
  ...
  <div class="panel-heading">
    <h3 class="panel-title">Crear Salas</h3>
  </div>
             ...
             <tr>
                ...
                <%
                    Coneccion con=new Coneccion();
                                    con.setConsulta("select * from establecimientos where estado='activo'");
                    %>
                <select  name="establecimiento_id" class="form-control">
                                    <% while(con.getResultado().next()){ %>
                                    <option value=<% out.println(""+con.getResultado().getString("establecimiento_id")); %>><% out.println(""+con.getResultado().getString("nombre")); %></option>
                                    <% } %>
                                    </td>
                                </select>
            </tr>
