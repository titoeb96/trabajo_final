...
<html lang="en">
  ...
  <div class="panel-heading">
    <h3 class="panel-title">Editar Salas</h3>
  </div>
        <br>
        ...
        <table class="table-condensed table-hover table-bordered">
            <tr>
                <td>Sala ID</td><td><input type="text" name="sala_id" readonly="true" value="<% out.println(""+sala_id);  %>"></td>
            </tr>
            <%  Coneccion con=new Coneccion();
                con.setConsulta("select * from Salas where sala_id='"+sala_id+"'");
            ...
            <tr>
             ...
             <tr>
                <td>Establecimiento_ID</td><td><input type="text" name="establecimiento_id" value="<% out.println(""+con.getResultado().getString("establecimiento_id"));  %>"></td>
            </tr>
