...
<html lang="en">
  ...
  <div class="panel-heading">
    <h3 class="panel-title">Editar Alumnos</h3>
  </div>
        <br>
        ...
        <form method="post" action="../ServletAlumno">
         <table class="table-condensed table-hover table-bordered">
            <tr>
                <td>Alumno ID</td><td><input type="text" name="alumno_id" readonly="true" value="<% out.println(""+alumno_id);  %>"></td>
            </tr>
            <%  Coneccion con=new Coneccion();
                con.setConsulta("select * from Alumnos where alumno_id='"+alumno_id+"'");
            ...
            <tr>
             ...
             <tr>
                <td>APEMAT</td><td><input type="text" name="apemat" value="<% out.println(""+con.getResultado().getString("apemat"));  %>"></td>
            </tr>
             <tr>
                <td>FECHANACIMIENTO</td><td><input type="text" name="fecha_nacimiento" value="<% out.println(""+con.getResultado().getString("fecha_nacimiento"));  %>"></td>
            </tr>
              <tr>
                <td>SALA_ID</td><td><input type="text" name="sala_id" value="<% out.println(""+con.getResultado().getString("sala_id"));  %>"></td>
            </tr>
